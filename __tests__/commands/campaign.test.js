...
describe('campaign : status command Unit Test', () => {
  ...
  test('display the correct status message based on current campaign ', async () => {
    ...
    const expectedEmbed = {
      ...
      color: 39423,
      description: `Currently in : ${currentPhase} \n This Phase will end ${currentPhase === 'Nomination Phase' ? moment(testCampaign.nominationPeriod).fromNow() : moment(testCampaign.votingPeriod).fromNow()}`
    }
